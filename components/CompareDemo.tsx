...
function CompareDemo() {
  return (
    <div className="relative group p-2 sm:p-4 border rounded-[2rem] dark:bg-neutral-900/50 bg-white/70 backdrop-blur-md border-neutral-200 dark:border-neutral-800 transition-all duration-500 hover:border-primary/30 shadow-xl dark:shadow-2xl overflow-hidden">
...
const CompareDemoSection = () => {
  return (
    <section className="relative mt-24  sm:mt-28 px-6 py-15 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-10 sm:space-y-16">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="inline-flex items-center gap-6 px-5 py-2.5 rounded-2xl bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md border border-neutral-200 dark:border-neutral-800 shadow-sm transition-all hover:border-primary/20">
            <span className="flex items-center gap-2 text-sm font-semibold">
              <div className="w-2.5 h-2.5 rounded-full bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]" /> 
              <span className="text-neutral-800 dark:text-neutral-300">Example</span>
            </span>
            <div className="h-4 w-px bg-neutral-300 dark:bg-neutral-700" />
            <span className="flex items-center gap-2 text-sm font-semibold">
              <div className="w-2.5 h-2.5 rounded-full bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)]" /> 
              <span className="text-neutral-800 dark:text-neutral-300">Standard</span>
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1 mt-4 lg:mt-0">
            <div className="space-y-3">
              ...
              <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-black dark:text-foreground text-balance leading-tight">
                Stop Searching, <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-blue-600 to-primary/80">
                  Start Shipping
                </span>
              </h2>
              <p className="text-base sm:text-lg text-black dark:text-neutral-300 leading-relaxed max-w-lg font-bold">
            ...
            <div className="grid gap-6">
              ...
              <div className="group space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold tracking-tight text-neutral-900 dark:text-foreground">Universal Syntax Support</h3>
                </div>
                <p className="text-sm sm:text-base text-black dark:text-neutral-400 pl-10 leading-relaxed font-semibold">
              ...
              <div className="group space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold tracking-tight text-neutral-900 dark:text-foreground">Copy, Paste, Ship</h3>
                </div>
                <p className="text-sm sm:text-base text-black dark:text-neutral-400 pl-10 leading-relaxed font-semibold">
              ...
              <div className="group space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold tracking-tight text-neutral-900 dark:text-foreground">Purely Beginner Friendly</h3>
                </div>
                <p className="text-sm sm:text-base text-black dark:text-neutral-400 pl-10 leading-relaxed font-semibold">
